...
class FactListModel(pydantic.BaseModel):
    """
    For fact list extraction, the structure is:
    schema:
    {
        "type": "object",
...
def get_pydantic_model(template_name: str) -> Type[pydantic.BaseModel]:
    ...
    Args:
        template_name: The name of the template (e.g., 'fact_list', 'triples').
